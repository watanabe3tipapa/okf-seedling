...
- **情報バンドル向けリンター**: 準拠チェック(必須 frontmatter・internal リンク)に加え、鮮度(stale_after 期限切れ)・欠落(title/description)・本文空などの品質警告
...
詳細は[チュートリアル](/tutorial/00-what-is-okf.qmd)(OKF 入門・用語集)と [DEV-MEMO](DEV-MEMO.md) を参照してください。
